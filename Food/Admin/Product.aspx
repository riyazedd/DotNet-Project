<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Food.Admin.Product" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                                                ...
                                                SetFocusOnError="true" ControlToValidate="textQuantity"></asp:RequiredFieldValidator>
                            ...
                            <div class="col-sm-6 col-md-8 col-lg-8 mobile-inputs">
                                <h4 class="sub-title">Category_List</h4>
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CommandName="delete" CssClass="badge bg-danger"
                                                            ...
                                                            OnClientClick="return confirm('Do you want to tdelete this product?');">
                                                        <i class="ti-trash"></i>
                                                        </asp:LinkButton>
                                                    </td>
